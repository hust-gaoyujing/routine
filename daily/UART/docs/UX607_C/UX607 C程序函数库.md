...
```shell
riscv-nuclei-elf-gcc -march=rv64imafdc -mabi=lp64 -static -mcmodel=medany -g -fvisibility=hidden -nostdlib -nostartfiles -I../../../vsim -I..//../env/p -I..//macros/scalar  -I /mnt/d/prj/routine/daily/UART/c_package/ux607_c/Libraries/Core/  -I /mnt/d/prj/routine/daily/UART/c_package/ux607_c/Libraries/Periph/inc -I /mnt/d/prj/routine/daily/UART/c_package/ux607_c/Libraries/Periph/src -I /mnt/d/prj/routine/daily/UART/c_package/ux607_c/Project/UART/UART_Init/ -T..//../env/p/link.ld  /mnt/d/prj/routine/daily/UART/c_package/ux607_c/Project/UART/UART_Init/main.c -o UART_INIT/uart_init
```

```shell
riscv-nuclei-elf-objdump --disassemble-all -S UART_INIT/uart_init > UART_INIT/uart_init.dump
```

```shell
riscv-nuclei-elf-objcopy -O verilog  UART_INIT/uart_init   UART_INIT/uart_init.verilog
```

```shell
sed -i 's/@800/@000/g' uart_init.verilog
sed -i 's/@00002FB8/@00002000/g' uart_init.verilog
sed -i 's/@00004FB8/@00004000/g' uart_init.verilog
sed -i 's/@00005FB8/@00005000/g' uart_init.verilog
sed -i 's/@00006FB8/@00006000/g' uart_init.verilog
```
