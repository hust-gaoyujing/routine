...
install: 
	...
	sed -i 's/n600/${CORE}/g' ${INSTALL_RTL}/system.v
	sed -i '1i\`define FPGA_SOURCE\'  ${INSTALL_RTL}/core/${CORE}_defines.v
	cp ${PWD}/${FPGA_NAME}/src/clkgate.v ${INSTALL_RTL}/core/${CORE}_clkgate.v -rf
	sed -i 's/n600/${CORE}/g' ${INSTALL_RTL}/core/${CORE}_clkgate.v	
...
.PHONY: verdi
verdi: 
	ls ${INSTALL_RTL}/*/*.v ${INSTALL_RTL}/*/*/*.v  -1 >& fpga_flist
